...
public:
  ...
  QString helpText() const override {
    return "This module allows streaming images to/from GStreamer.<br><br>"
      ...
      "<b>Abstract Sockets:</b><br>"
      "Prefix a socket path with '@' (e.g. @slicer_gstreamer_View1) to use a Linux abstract-namespace "
      "socket instead of a filesystem path. Abstract sockets leave no file on disk and need no cleanup.<br><br>"
      "<b>WebRTC Note:</b><br>"
